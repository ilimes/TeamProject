			...
			<div>
				...
				<div class="row upDiv">
					...
					<div class="col-md-12" style="margin-bottom: 20px;">
						<div>
							<button type="button" class="btnBlack" onclick="mainSearch();">검색</button>
						</div>
					</div>
					<div class="col-md-12">
						<div>
							<h4>
								<strong>베스트후기</strong><span style="font-size: 12.5px; margin-left: 5px; padding: 4px; cursor: pointer; background-color: #DDD; border-radius: 8px;" onclick="location.href='/item/bestReview?menuCode=MENU_002';">더보기</span>
							</h4>
						</div>
						<div>
							<table>
